#pytest -v --driver Chrome --driver-path chromedriver.exe  test_selenium_petfriends_web.py
...
def test_petfriends(web_browser):
   ...
   field_email.clear()
   field_email.send_keys("rasdvatri@mail.ru")

   # add password
   field_pass = web_browser.find_element_by_id("pass")
   field_pass.clear()
   field_pass.send_keys("test12345")
